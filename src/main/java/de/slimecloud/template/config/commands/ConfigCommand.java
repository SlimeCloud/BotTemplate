...
import de.slimecloud.template.main.CommandPermission;
...
public class ConfigCommand {
	...
	@Setup
	public static void setup(@NotNull Bot bot, @NotNull UIManager uiManager, @NotNull CommandManager<ICommandContext, ?> cmdManager, @NotNull Command<ICommandContext> command) {
