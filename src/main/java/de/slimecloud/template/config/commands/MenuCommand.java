...
public class MenuCommand {
	...
	public MenuCommand(@NotNull Bot bot, @NotNull UIManager manager) {
	...
	@NotNull
	private static MessageMenu createCategory(@NotNull Bot bot, @NotNull UIManager manager, @NotNull Function<GuildConfig, Object> instance, @NotNull CategoryInfo category, @NotNull Field[] fields) {
	...
	@NotNull
	private static MessageMenu createFieldMenu(@NotNull Bot bot, @NotNull UIManager manager, @NotNull Info info, @NotNull Type generic, @NotNull Function<GuildConfig, Object> categoryInstance, @NotNull Getter getter, @NotNull Setter setter, @NotNull Function<DataState<?>, String> display, @NotNull CategoryInfo category, @NotNull ConfigField field, @Nullable ConfigFieldType keyType) {
	...
	private static void set(@NotNull Bot bot, @NotNull DataState<?> state, @NotNull Function<GuildConfig, Object> category, @NotNull Setter setter, @Nullable Object value) {
	...
	@SuppressWarnings("unchecked")
	private static <T> T get(@NotNull Bot bot, @NotNull DataState<?> state, @NotNull Getter getter) {
		return (T) getter.get(state, bot.loadGuild(state.getEvent().getGuild()));
	}

	@SuppressWarnings("unchecked")
	private static <T> void handle(@NotNull Bot bot, @NotNull DataState<?> state, @NotNull Function<GuildConfig, Object> category, @NotNull Getter getter, @NotNull Consumer<T> handler) {
		GuildConfig config = bot.loadGuild(state.getEvent().getGuild());
	...
	@NotNull
	private static MessageMenu createValueMenu(@NotNull Bot bot, @NotNull UIManager manager, @NotNull Info info, @NotNull Class<?> type, @NotNull Function<GuildConfig, Object> categoryInstance, @NotNull Getter getter, @NotNull Setter setter, @NotNull Function<DataState<?>, String> display, @NotNull CategoryInfo category, @NotNull ConfigField field) {
	...
	private static MessageMenu createListValueMenu(@NotNull Bot bot, @NotNull UIManager manager, @NotNull Info info, @NotNull Class<?> type, @NotNull Type generic, @NotNull Function<GuildConfig, Object> categoryInstance, @NotNull Getter getter, @NotNull Setter setter, @NotNull Function<DataState<?>, String> display, @NotNull CategoryInfo category, @NotNull ConfigField field) {
	...
	@NotNull
	@SuppressWarnings({"rawtypes", "unchecked"})
	private static MessageMenu createEnumSetValueMenu(@NotNull Bot bot, @NotNull UIManager manager, @NotNull Info info, @NotNull Type generic, @NotNull Function<GuildConfig, Object> categoryInstance, @NotNull Getter getter, @NotNull Setter setter, @NotNull Function<DataState<?>, String> display, @NotNull CategoryInfo category, @NotNull ConfigField field) {
	...
	private static MessageMenu createMapValueMenu(@NotNull Bot bot, @NotNull UIManager manager, @NotNull Info info, @NotNull Class<?> type, @NotNull Type generic, @NotNull Function<GuildConfig, Object> categoryInstance, @NotNull Getter getter, @NotNull Setter setter, @NotNull Function<DataState<?>, String> display, @NotNull CategoryInfo category, @NotNull ConfigField field, @Nullable ConfigFieldType keyType) {
